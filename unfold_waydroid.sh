...
# Bliss-Bass LineageOS unfolding profile
#
...
LOCAL_PATH=$(pwd)
bass_patch_dir="${LOCAL_PATH}/patches-waydroid"
...
cp ${LOCAL_PATH}/manifests/waydroid-static.xml lineage.xml
...
git add *
git commit --no-edit -m "Add Bass Toolkit"
popd
