...
LOCAL_PATH=$(pwd)
bass_patch_dir="${LOCAL_PATH}/patches-bassos12"
...
cd .repo/manifests
rm default.xml
cp ${LOCAL_PATH}/manifests/blissos15-static.xml bliss.xml
cp ${LOCAL_PATH}/manifests/bass12.xml bass.xml
...
# copy vendor configs
if [ -f ${LOCAL_PATH}/configs/vendor/bliss_os_15/vendor_config.cfg ]; then
    cp ${LOCAL_PATH}/configs/vendor/bliss_os_15/vendor_config.cfg .config/vendor_config.cfg
fi
