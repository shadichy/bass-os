...
mkdir -p iso
iso_exists=$(find out/target/product/virtio_x86_64/ -maxdepth 1 -mindepth 1 -type f -name "*.iso")
if [[  "$iso_exists" != "" ]]; then 
...
sha256_files=$(find out/target/product/virtio_x86_64/ -maxdepth 1 -mindepth 1 -type f -name "*.sha256")
...
zip_files=$(find out/target/product/virtio_x86_64/ -maxdepth 1 -mindepth 1 -type f -name "*.zip" ! -iname "*ota-eng.nobody*")
...
changelog_exists=$(find out/target/product/virtio_x86_64/ -maxdepth 1 -mindepth 1 -type f -name "Changelog*")
