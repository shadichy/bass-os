...
function copy_wallpaper()
{
    if [ -f vendor/$vendor_branding_name/branding/wallpaper/* ]; then
        ...
        echo ""
        cp -r vendor/$vendor_branding_name/branding/wallpaper/* vendor/$vendor_branding_name/overlay/branding/frameworks/base/core/res/res/drawable-hdpi/
        cp -r vendor/$vendor_branding_name/branding/wallpaper/* vendor/$vendor_branding_name/overlay/branding/frameworks/base/core/res/res/drawable-mdpi/
        cp -r vendor/$vendor_branding_name/branding/wallpaper/* vendor/$vendor_branding_name/overlay/branding/frameworks/base/core/res/res/drawable-nodpi/
        cp -r vendor/$vendor_branding_name/branding/wallpaper/* vendor/$vendor_branding_name/overlay/branding/frameworks/base/core/res/res/drawable-xhdpi/
        cp -r vendor/$vendor_branding_name/branding/wallpaper/* vendor/$vendor_branding_name/overlay/branding/frameworks/base/core/res/res/drawable-xxhdpi/
        cp -r vendor/$vendor_branding_name/branding/wallpaper/* vendor/$vendor_branding_name/overlay/branding/frameworks/base/core/res/res/drawable-xxxhdpi/
        cp -r vendor/$vendor_branding_name/branding/wallpaper/* vendor/$vendor_branding_name/overlay/branding/frameworks/base/core/res/res/drawable-sw600dp-nodpi/
        cp -r vendor/$vendor_branding_name/branding/wallpaper/* vendor/$vendor_branding_name/overlay/branding/frameworks/base/core/res/res/drawable-sw720dp-nodpi/
